    ...
    <div className="p-6 space-y-4">
      ...
      <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200">
        ...
        <div className="space-y-3">
          {[
            { name: 'IST 263 - Web Design', grade: 'A-', credits: 3 },
            { name: 'IST 346 - Information Tech', grade: 'B+', credits: 3 },
            { name: 'IST 387 - Intro to Blockchain', grade: 'A', credits: 3 },
            { name: 'IST 411 - Information Security', grade: 'A-', credits: 3 }
          ].map((course, i) => (
    ...
    <div className="p-6 space-y-4">
      ...
      <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200">
        ...
        <div className="space-y-4">
          {[
            { user: 'Tech Club', post: 'Hackathon this weekend! Sign up now 🚀', time: '2h ago' },
            { user: 'Student Union', post: 'Free pizza at the Schine Center today!', time: '4h ago' },
            { user: 'Basketball Team', post: 'Game tonight vs Duke. Let\'s go Orange! 🏀', time: '6h ago' }
          ].map((item, i) => (
      ...
      <div className="bg-white rounded-lg p-5 shadow-sm border border-gray-200">
        ...
        <div className="grid grid-cols-2 gap-3">
          {['Tech Club', 'IST Study Group', 'Basketball Fans', 'Entrepreneurs'].map((group, i) => (
            <div key={i} className="p-3 bg-blue-50 rounded-lg text-center">
              <p className="font-medium text-blue-900 text-sm">{group}</p>
            </div>
          ))}
        </div>
      </div>
